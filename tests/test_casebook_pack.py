"""Regression checks for the nexus-move-endgame-mark casebook."""
...
from casebook.harness import assert_expected, nexus_move_endgame_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_move_endgame_mark_summary(), assert_expected())
