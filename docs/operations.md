...
`nexus-move-endgame-mark` is centered on chess and game engines work in Elixir. The technical target is: Build an Elixir toolkit that studies endgame behavior through log and snapshot fixtures, with replay consistency checks and offline replay mode.
